...
function LoginPage() {
    ...
    const handleLogin = async (e)=>{
        ...
        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signIn"])("email", {
            email,
            redirect: false
        });
        if (res?.ok) {
...
_s(LoginPage, "bqjAz8mumNdR/Yy7oipnbRjVtC8=", false, function() {
    return [
